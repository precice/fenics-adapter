...
3. Bump the version in  in `CHANGELOG.md` on `fenics-adapter-vX.X.X`.
...
8. Add an empty commit (details see in this [issue](https://github.com/precice/python-bindings/issues/109)) on master by running the steps:
